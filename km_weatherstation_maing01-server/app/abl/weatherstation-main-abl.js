...
const Errors = require("../api/errors/weatherstation-main-error.js");
...
const logger = LoggerFactory.get("WeatherstationMainAbl");
...
class WeatherstationMainAbl {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["weatherstationMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "KmWeatherstation",
        typeCode: "km-weatherstation-maing01",
        location: location,
